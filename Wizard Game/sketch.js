...
var gameState = "play";
var gameover, gameoverImage, reset, resetImage, win, winImage;
...
function draw(){
  ...
  text("Score: " + score, wizard.x + 400, 20)
  text("Highscore: "+ highScore, wizard.x + 300, 20)
  ...
  if (gameState == "play"){
    ...
    if(score >= 1000){
      ...
      win = createSprite(wizard.x + 200, 100);
...
function fire(){
  ...
  fireball.velocityX = wizard.velocityX + 5;
